...
namespace Sensei\SortingPro\Block\Widget;

use Sensei\SortingPro\Model\Source\SortOrder;
...
class Featured extends ProductsList
{
    ...
    {
        if (!$this->hasData('scsorting_sort_order')) {
            $this->setData('scsorting_sort_order', self::DEFAULT_COLLECTION_ORDER);
        }
        return $this->getData('scsorting_sort_order');
    }
}
