 ...
 */
class UzerJobBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'UzerJob';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'uzer_jobs/uzerjob/edit';
    private const DELETE_URL_PATH = 'uzer_jobs/uzerjob/delete';
    /** #@- */
