...
namespace Uzer\Jobs\Ui\Component\Listing\Column;
 ...
 */
class RequestJobBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'RequestJob';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'request_job/requestjob/edit';
    private const DELETE_URL_PATH = 'request_job/requestjob/delete';
    /** #@- */
