...
use Uzer\Samples\Command\SamplesCart\DeleteByIdCommand;

/**
 * Delete SamplesCart controller.
 */
class Delete extends Action implements HttpPostActionInterface, HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('You have successfully deleted SamplesCart entity'));
