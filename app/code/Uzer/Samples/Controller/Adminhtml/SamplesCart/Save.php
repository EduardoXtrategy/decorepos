...
/**
 * Save SamplesCart controller action.
 */
class Save extends Action implements HttpPostActionInterface
{
     ...
     * @param SamplesCartInterfaceFactory $entityDataFactory
     */
    public function __construct(
        Context                     $context,
        DataPersistorInterface      $dataPersistor,
        SaveCommand                 $saveCommand,
        SamplesCartInterfaceFactory $entityDataFactory
    )
    {
    ...
    public function execute()
    {
        ...
        try {
            /** @var SamplesCartInterface|DataObject $entityModel */
            $entityModel = $this->entityDataFactory->create();
            $entityModel->addData($params['general']);
            $this->saveCommand->execute($entityModel);
            $this->messageManager->addSuccessMessage(
                __('The SamplesCart data was saved successfully')
            );
