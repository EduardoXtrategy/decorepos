 ...
 */
class SamplesCartBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'SamplesCart';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'samples_cart/samplescart/edit';
    private const DELETE_URL_PATH = 'samples_cart/samplescart/delete';
    /** #@- */
