...
namespace Uzer\Samples\Ui\Component\Listing\Column;
 ...
 */
class SampleOrderBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'SampleOrder';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'sample_order/sampleorder/edit';
    private const DELETE_URL_PATH = 'sample_order/sampleorder/delete';
    /** #@- */
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['entity_id'])) {
                    ...
                    $item[$this->getData('name')] = [
                        'edit' => $this->getActionData($editUrl, (string)__('View')),
