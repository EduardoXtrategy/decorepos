...
namespace Uzer\Search\Ui\Component\Listing\Column;
 ...
 */
class ProductBannerBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'ProductBanner';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'product_banner/productbanner/edit';
    private const DELETE_URL_PATH = 'product_banner/productbanner/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[ProductBannerInterface::ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [ProductBannerInterface::ENTITY_ID => $item[ProductBannerInterface::ENTITY_ID]];
