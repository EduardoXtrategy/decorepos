    ...
    $.widget('rokanthemes.ajaxsuite', {
        ...
        initEventsTopLinkClickWishlist: function()
        {
            ...
            if(!self.options.customerId){
                $('.wishlist-custom-button-login a').addClass("trigger-auth-popup").attr('data-action', 'ajax-popup-login').attr('href', '#');
                $('.custom-button-login').addClass("trigger-auth-popup").attr('data-action', 'ajax-popup-login').attr('href', '#');
            }
        },
