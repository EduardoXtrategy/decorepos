...
namespace Amasty\SeoToolkitLite\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_seoToolkitLite_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_SeoToolkitLite::css/source/mkcss/amseokit.css');
        }
