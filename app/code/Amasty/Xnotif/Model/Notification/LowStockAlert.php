...
class LowStockAlert
{
    public const XML_PATH_EMAIL_TO = 'admin_notifications/stock_alert_email';

    public const XML_PATH_SENDER_EMAIL = 'admin_notifications/sender_email_identity';

    public const TEMPLATE_FILE = 'Amasty_Xnotif::notifications/low_stock_alert.phtml';
