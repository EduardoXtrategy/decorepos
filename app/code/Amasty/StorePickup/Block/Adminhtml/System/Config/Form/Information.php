...
namespace Amasty\StorePickup\Block\Adminhtml\System\Config\Form;
...
class Information extends \Magento\Config\Block\System\Config\Form\Fieldset
{
     ...
     * @var string
     */
    private $userGuideLink = 'https://amasty.com/docs/doku.php?id=magento_2:store-pickup';
    ...
    public const MODULE_CODE = 'Amasty_StorePickup';
    ...
    public function getUserGuideLink()
    {
        ...
        if (strpos($this->userGuideLink, '?') !== false) {
            $seoLink = str_replace('?', '&', $seoLink);
        }

        $this->userGuideLink .= $seoLink . 'userguide_' . self::MODULE_CODE;
